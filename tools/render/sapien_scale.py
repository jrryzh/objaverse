...
def main():
    ...
    for urdf_path in objaverse_urdf_lst[:10]:
        ...
        try:
            ...
            # instance_path = os.path.join("/home/add_disk_e/objaverse_lvis_trimesh_objs_normalized_output_test_fixlink/3k_10k/", objaverse_id)
